...
* We convert the _location_ variable to a set of dummy variables for each location (We set Vancouver's location equivalent to DC because they share a species and peak threshold)
