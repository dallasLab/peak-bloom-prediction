...
```{r eval=FALSE}
cherry <- dplyr::filter(cherry, location!="liestal" | year!=2017) #Missing previous Dec
...
```{r}
table(is.na(cherry))
table(is.na(cherry[,36])) #I don't know why this doesn't work.There are two Nas in the problem month, but I thought the function should be able to handle NAs just fine. idk.
colnames(cherry)[36]
